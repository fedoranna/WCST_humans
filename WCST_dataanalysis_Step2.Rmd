...
The histogram of task times shows that the data is not normally distributed, so we had to use nonparametric tests.

We also used binary logistic regression.

```{r Plots for task difficulty}
...
We used Fisher's exact tests to make pairwise comparison between conditions regarding the aha-ratings of solvers (whether they reported having aha-feelings or not).
